# A2500 MAIN HOME CURRENT Current TDD Max { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_CURRENT_TDD_Max.png" alt="A2500 MAIN HOME CURRENT Current TDD Max">
  ...
  <a class="screen-hotspot" href="../home-current-tdd/" title="Clear Max state" aria-label="Clear Max state" style="left:84.4%; top:26.5%; width:12.6%; height:8.7%;">Max</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <p>근거: <code>Policy-23-0018</code>, <code>Policy-23-0023</code>, <code>Policy-23-0049</code>, <code>Policy-24-0003</code>, <code>Policy-25-0001</code></p>
    <h4>공통 정책</h4>
    <ul>
