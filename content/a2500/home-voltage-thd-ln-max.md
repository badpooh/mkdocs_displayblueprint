# A2500 MAIN HOME VOLTAGE THD L-N Max { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_VOLTAGE_THD_LN_Max.png" alt="A2500 MAIN HOME VOLTAGE THD L-N Max">
  ...
  <a class="screen-hotspot" href="../home-voltage-thd-ll-max/" title="Go to THD L-L" aria-label="Go to THD L-L" style="left:58.8%; top:26.5%; width:12.6%; height:8.7%;">L-L</a>
  <a class="screen-hotspot" href="../home-voltage-thd-ln/" title="Clear Max state" aria-label="Clear Max state" style="left:84.4%; top:26.5%; width:12.6%; height:8.7%;">Max</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <ul>
      ...
      <li>THD 화면은 우측 상단 상태 버튼으로 <code>Max</code>만 제공한다(<code>Min</code> 없음). 선택 중인 버튼을 다시 누르거나 같은 메뉴를 다시 선택하면 기본 화면 상태로 돌아간다.</li>
    </ul>
