# A2500 MAIN SETUP NETWORK Ethernet { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/SETUP/MAIN_SETUP_NETWORK_Ethernet.png" alt="A2500 MAIN SETUP NETWORK Ethernet">
  ...
  <a class="screen-hotspot" href="../setup-network-ethernet/" title="Go to SETUP NETWORK Ethernet" aria-label="Go to SETUP NETWORK Ethernet" style="left:0%; top:24%; width:19.4%; height:9.2%;">Ethernet</a>
  <a class="screen-hotspot" href="../setup-network-rs485/" title="Go to SETUP NETWORK RS485" aria-label="Go to SETUP NETWORK RS485" style="left:0%; top:33%; width:19.4%; height:9.6%;">RS485</a>
  <a class="screen-hotspot" href="../setup-network-advanced/" title="Go to SETUP NETWORK Advanced" aria-label="Go to SETUP NETWORK Advanced" style="left:0%; top:42.5%; width:19.4%; height:9.6%;">Advanced</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    <h4>화면 정책</h4>
    <ul>
      <li><code>Ethernet</code>, <code>RS485</code>, <code>Advanced</code> 설정은 네트워크 설정 정책의 항목명과 입력 범위를 따른다.</li>
      <li><code>Advanced</code>의 ACL/보안 관련 항목은 A2500 회의 문서에서 정리한 Advanced 정책을 우선한다.</li>
    </ul>
    <p>근거: <code>Policy-24-0002</code>, <code>Policy-24-0030</code>, <code>임시회의-20260326</code></p>
  </div>
</details>
<!-- codex-policy-end -->
