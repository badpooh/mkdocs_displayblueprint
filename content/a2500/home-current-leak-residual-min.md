# A2500 MAIN HOME CURRENT Leak & Residual Min { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_CURRENT_Leak_Min.png" alt="A2500 MAIN HOME CURRENT Leak & Residual Min">
  ...
  <a class="screen-hotspot" href="../home-current-leak-residual/" title="Clear Min state" aria-label="Clear Min state" style="left:71.8%; top:26.5%; width:12.6%; height:8.7%;">Min</a>
  <a class="screen-hotspot" href="../home-current-leak-residual-max/" title="Go to Max state" aria-label="Go to Max state" style="left:84.4%; top:26.5%; width:12.6%; height:8.7%;">Max</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <p>근거: <code>Policy-23-0018</code>, <code>Policy-23-0044</code>, <code>Policy-23-0048</code>, <code>Policy-23-0049</code>, <code>Policy-24-0003</code>, <code>Policy-25-0001</code></p>
    <details class="policy-details">
      <summary>잔류전류 표시 자리수</summary>
      <div class="policy-details__body">
        <ul>
          <li>ZCT의 범위는 <code>0~2,000 mA</code>이며 <code>mA</code> 단위의 정수로 표시한다.</li>
          <li>잔류전류 자리수는 전류와 동일하게 표시한다.</li>
          <li>Reading 값은 4자리로 표시한다.</li>
        </ul>
      </div>
    </details>
    <details class="policy-details">
      <summary>Leakage/Residual 표시 순서</summary>
      <div class="policy-details__body">
        <ul>
          <li><code>Leakage Current</code>는 <code>Fund.</code>를 위에 표시한다.</li>
          <li><code>Fund.</code>는 정밀도 기준을 만족하지만 <code>RMS</code>는 정밀도 기준을 만족하지 않아 표시 순서가 다르다.</li>
          <li><code>Residual Current</code>도 <code>Leakage Current</code>와 같은 표시 순서를 적용한다.</li>
          <li><code>VOLTAGE &gt; Residual Voltage</code>는 별도 표시 기준이므로 일반 순서대로 <code>RMS</code>를 먼저 표시한다.</li>
        </ul>
      </div>
    </details>
    <details class="policy-details">
      <summary>모델별 표시 항목</summary>
      <div class="policy-details__body">
        <table>
          <thead>
            <tr><th>표시 항목</th><th>대상 모델/조건</th></tr>
          </thead>
          <tbody>
            <tr><td><code>Leakage</code></td><td><code>CMZ-1P</code>, <code>CMS-1P3F+ZM</code>, <code>CMS-2P_1P2W+외부ZCT</code>, <code>CMS-2P_1P2F+외부ZCT</code>, <code>CMS-1P3F-DIZCT</code></td></tr>
            <tr><td><code>Residual</code></td><td><code>CM-3P_3Pmode</code>, <code>CMM-3P_3Pmode</code>, <code>CMS-3P4W-단독</code>, <code>CMS-2P_3P4W</code>, <code>CMS-3P-5A_3Pmode</code></td></tr>
            <tr><td><code>Leak. &amp; Residual</code></td><td><code>CMZ-3P</code>, <code>CMZ-3P4W-단독</code>, <code>CMS-3P4W+ZM</code>, <code>CMMZ-3P</code>, <code>CM-3P+외부ZCT</code>, <code>CMS-2P_3P4W+외부ZCT</code>, <code>CMS-3P-5A+외부ZCT</code></td></tr>
            <tr><td>없음</td><td><code>CM-1P</code>, <code>CMS-1P3F-단독</code>, <code>CM-3P_1Pmode</code>, <code>CMM-3P_1Pmode</code>, <code>CMS-2P_1P2W</code>, <code>CMS-2P_1P2F</code>, <code>CMS-2P_3P3W</code></td></tr>
          </tbody>
        </table>
      </div>
    </details>
