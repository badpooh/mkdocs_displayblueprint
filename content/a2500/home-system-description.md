# A2500 MAIN HOME SYSTEM Description { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_SYSTEM_Description.png" alt="A2500 MAIN HOME SYSTEM Description">
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <details class="policy-details">
      <summary>MAIN 전용 항목</summary>
      <div class="policy-details__body">
        <ul>
          <li><code>Installation Date</code> 항목은 MAIN 화면에서만 표시한다.</li>
        </ul>
      </div>
    </details>
  </div>
