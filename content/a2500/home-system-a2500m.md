# A2500 MAIN HOME SYSTEM A2500M Information { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_SYSTEM_A2500M.png" alt="A2500 MAIN HOME SYSTEM A2500M Information">
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <details class="policy-details">
      <summary>Serial Number 구성</summary>
      <div class="policy-details__body">
        <ul>
          <li><code>Serial Number</code>는 <code>제품 PID, SERIAL NUMBER</code> 문서 기준을 따른다.</li>
          <li>구성은 <code>PID(2자리 문자 또는 숫자) + Serial(6자리 정수)</code>이다.</li>
          <li>참조 경로: <code>\\10.10.10.23\11_연구개발부_스마트디바이스_대외비\3_제품개발\00_개발현안공유 및 공통문서\제품PID_Serial번호_MAC</code></li>
        </ul>
      </div>
    </details>
    <details class="policy-details">
      ...
      <div class="policy-details__body">
        <table>
          <thead><tr><th>대상</th><th>PID</th></tr></thead>
          <tbody>
            <tr><td>A2500M 일반 제품</td><td><code>E0000000</code></td></tr>
            <tr><td>A2500M PWM 제품</td><td><code>D8000000</code></td></tr>
          </tbody>
        </table>
      </div>
    </details>
