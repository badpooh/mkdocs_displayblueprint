# A2500 MAIN HOME ANALYSIS Current Symmetrical Component Max { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_ANALYSIS_CurrSymm_Max.png" alt="A2500 MAIN HOME ANALYSIS Current Symmetrical Component Max">
  ...
  <a class="screen-hotspot" href="../home-analysis-curr-symm/" title="Clear Max state" aria-label="Clear Max state" style="left:84.4%; top:26.5%; width:12.6%; height:8.7%;">Max</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <details class="policy-details">
      ...
      <div class="policy-details__body">
        <ul>
          <li>단상 모듈에서는 <code>Curr. Symm.</code> 서브 메뉴를 표시하지 않는다.</li>
        </ul>
      </div>
    </details>
    <h4>공통 정책</h4>
