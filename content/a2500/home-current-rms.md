# A2500 MAIN HOME CURRENT RMS { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_CURRENT_RMS.png" alt="A2500 MAIN HOME CURRENT RMS">
  ...
  <a class="screen-hotspot" href="../home-voltage-rms/" title="Go to HOME VOLTAGE RMS L-L" aria-label="Go to HOME VOLTAGE RMS L-L" style="left:0%; top:12.5%; width:17.5%; height:10.5%;">VOLTAGE</a>
  ...
  <a class="screen-hotspot" href="../home-current-rms-min/" title="Go to Current RMS Min state" aria-label="Go to Current RMS Min state" style="left:71.8%; top:26.5%; width:12.6%; height:8.7%;">Min</a>
  <a class="screen-hotspot" href="../home-current-rms-max/" title="Go to Current RMS Max state" aria-label="Go to Current RMS Max state" style="left:84.4%; top:26.5%; width:12.6%; height:8.7%;">Max</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <details class="policy-details">
      <summary>상설정에 따른 표시 변경</summary>
      <div class="policy-details__body">
        <ul>
          <li>모듈의 상설정에 따라 CURRENT RMS 표시가 변경된다.</li>
          <li><code>분기 &gt; SETUP &gt; MEASUREMENT &gt; Load Wiring &gt; Phase Selection</code> 설정을 기준으로 한다.</li>
          <li><code>L-N</code> 설정(<code>AN</code>, <code>NA</code> 등): <code>A</code>, <code>B</code>, <code>C</code>로 표시한다.</li>
          <li><code>L-L</code> 설정(<code>AB</code>, <code>BA</code> 등): <code>AB</code>, <code>BC</code>, <code>CA</code>로 표시한다.</li>
          <li><code>BA</code>처럼 역상으로 설정되어도 화면에는 역상 표기를 사용하지 않는다.</li>
        </ul>
      </div>
    </details>
    <h4>공통 정책</h4>
