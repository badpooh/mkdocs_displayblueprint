# A2500 MAIN HOME ANALYSIS Harmonics Text 4 { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_ANALYSIS_Harmonics_text_4.png" alt="A2500 MAIN HOME ANALYSIS Harmonics Text 4">
  ...
  <a class="screen-hotspot" href="../home-analysis-harmonics-text-1/" title="Switch Harmonics unit between voltage and current" aria-label="Switch Harmonics unit between voltage and current" style="left:21.8%; top:37.6%; width:15.0%; height:7.7%;">Unit</a>
  <a class="screen-hotspot" href="../home-analysis-harmonics-8/" title="Switch Harmonics display to Graph" aria-label="Switch Harmonics display to Graph" style="left:38.0%; top:37.6%; width:15.2%; height:7.7%;">Graph/Text</a>
  <a class="screen-hotspot" href="../home-analysis-harmonics-text-1/" title="Switch Harmonics to Voltage" aria-label="Switch Harmonics to Voltage" style="left:66.8%; top:26.4%; width:15.0%; height:8.9%;">Voltage</a>
  <a class="screen-hotspot" href="../home-analysis-harmonics-text-4/" title="Switch Harmonics to Current" aria-label="Switch Harmonics to Current" style="left:82.0%; top:26.4%; width:15.0%; height:8.9%;">Current</a>
  <a class="screen-hotspot" href="../home-analysis-harmonics-text-4/" title="Switch Harmonics text table to A" aria-label="Switch Harmonics text table to A" style="left:74.4%; top:37.5%; width:7.4%; height:8.4%;">A</a>
  <a class="screen-hotspot" href="../home-analysis-harmonics-text-5/" title="Switch Harmonics text table to B" aria-label="Switch Harmonics text table to B" style="left:81.8%; top:37.5%; width:7.4%; height:8.4%;">B</a>
  <a class="screen-hotspot" href="../home-analysis-harmonics-text-6/" title="Switch Harmonics text table to C" aria-label="Switch Harmonics text table to C" style="left:89.2%; top:37.5%; width:7.5%; height:8.4%;">C</a>
</div>
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    <h4>화면 정책</h4>
    <ul>
      <li><code>Harmonics</code>는 전압/전류 단위 전환, Graph/Text 전환, 상별 체크 버튼 상태에 따라 화면 상태가 바뀐다.</li>
      <li>Graph/Text, Y축, 리스트, 고조파 차수 표시는 Harmonics 전용 정책을 따른다.</li>
      <li>단상/결선 조건에서 표시 가능한 상만 노출하며, 상/전압/전류 색상은 공통 분석 화면 색상 정책을 따른다.</li>
    </ul>
    <p>근거: <code>Policy-23-0007</code>, <code>Policy-23-0008</code>, <code>Policy-23-0009</code>, <code>Policy-23-0010</code>, <code>Policy-23-0012</code>, <code>Policy-24-0024</code>, <code>Policy-23-0018</code>, <code>임시회의-20240725</code></p>
    <h4>공통 정책</h4>
    <ul>
