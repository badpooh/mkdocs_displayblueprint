# A2500 MAIN HOME SYSTEM A2550CMZ Information { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_SYSTEM_A2550CMZ.png" alt="A2500 MAIN HOME SYSTEM A2550CMZ Information">
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <details class="policy-details">
      <summary>Main CM 설정에 따른 표시</summary>
      <div class="policy-details__body">
        <table>
          <thead><tr><th>조건</th><th>표시</th></tr></thead>
          <tbody>
            <tr><td>CMZ</td><td><code>A2550CMZ</code></td></tr>
            <tr><td>CM</td><td><code>A2550CM</code></td></tr>
            <tr><td>CMS-단독</td><td><code>A2550CMS</code></td></tr>
            <tr><td>CMS+ZM</td><td><code>A2550ZM</code></td></tr>
            <tr><td>CMM</td><td><code>A2550CMM</code></td></tr>
            <tr><td>CMMZ</td><td><code>A2550CMMZ</code></td></tr>
          </tbody>
        </table>
      </div>
    </details>
    <details class="policy-details">
      <summary>Module Connection 표시</summary>
      <div class="policy-details__body">
        <table>
          <thead><tr><th>조건</th><th>표시</th></tr></thead>
          <tbody>
            <tr><td>CMZ-3P</td><td><code>3P</code></td></tr>
            <tr><td>CMZ-1P</td><td><code>1P</code></td></tr>
          </tbody>
        </table>
      </div>
    </details>
    <details class="policy-details">
      ...
      <div class="policy-details__body">
        <ul>
          ...
          <li>A2550CMZ-3P-60A의 PID는 <code>EK</code>이다.</li>
          <li>A2550CMZ-1P-60A의 PID는 <code>EG</code>이다.</li>
        </ul>
      </div>
    </details>
    <details class="policy-details">
      <summary>Module Status 표시</summary>
      <div class="policy-details__body">
        <ul>
          <li>Module Status는 <code>Unknown</code>, <code>Bootloader</code>, <code>Identified</code>, <code>Operation (@정상동작)</code>으로 표시한다.</li>
        </ul>
      </div>
    </details>
    <h4>공통 정책</h4>
