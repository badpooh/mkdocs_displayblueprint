# A2500 MAIN HOME SYSTEM Network State { .screen-title-fit }

<div class="screen-link-wrap">
  <img src="/assets/screens/MAIN/HOME/MAIN_HOME_SYSTEM_NetworkState.png" alt="A2500 MAIN HOME SYSTEM Network State">
...
<details class="policy-details">
  ...
  <div class="policy-details__body">
    ...
    <details class="policy-details">
      <summary>Partner State</summary>
      <div class="policy-details__body">
        <ul>
          <li><code>Partner State</code>는 각 포트에 연결된 모듈의 상태를 표시한다.</li>
        </ul>
      </div>
    </details>
    <details class="policy-details">
      <summary>Port State</summary>
      <div class="policy-details__body">
        <ul>
          <li><code>Port#1 State</code>와 <code>Port#2 State</code>는 포트 역할에 따라 <code>Root</code>, <code>Designated</code>, <code>Alternative</code>로 표시한다.</li>
        </ul>
      </div>
    </details>
    <details class="policy-details">
      <summary>Ethernet 통신 상태</summary>
      <div class="policy-details__body">
        <ul>
          <li>Star 구성은 <code>[STAR]</code>로 표시한다.</li>
          <li>Daisy chain 또는 Ring 구성은 <code>[RING]</code>으로 표시한다.</li>
          <li>연결되지 않은 상태는 <code>[Not Connected]</code>로 표시한다.</li>
        </ul>
      </div>
    </details>
  </div>
